...
# ==================== 用户真实持仓配置 ====================
# 单位：元（持有金额），请根据实际情况修改
# 前端 Dashboard 也支持在线编辑，会自动保存到浏览器 localStorage

USER_HOLDINGS = {
    "024418": 1046.68,   # 华夏上证科创板半导体材料设备主题ETF发... (实际: 华夏科创半导体ETF联接C)
    "006502": 409.94,    # 财通集成电路产业股票A
    "005125": 492.17,    # 华宝标普中国A股红利机会ETF联接C
    "012738": 1007.18,   # 广发创新药ETF联接C
    "008087": 514.84,    # 华夏中证5G通信主题ETF联接C
    "026211": 1024.78,   # 平安科技精选混合发起式C
    "018177": 833.14,    # 华夏科创50指数增强A
    "001052": 559.55,    # 华夏中证500ETF联接A
    "110020": 551.91,    # 易方达沪深300ETF联接A
    "016453": 100.00,    # 南方纳斯达克100指数发起(QDII)C
    "007531": 981.84,    # 华宝券商ETF联接C
    "014915": 51.11,     # 财通匠心优选一年持有期混合A
}
